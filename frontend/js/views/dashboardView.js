    ...
    <div class="page">
      ...
      <div class="grid-4" style="margin-bottom:24px">
        ...
        <div class="card card--stat">
          ...
          <div>
            <div class="stat-value">${stats.pending_commissions_usd > 0 ? formatUSD(stats.pending_commissions_usd) : ''}${stats.pending_commissions_usd > 0 && stats.pending_commissions_mn > 0 ? ' + ' : ''}${stats.pending_commissions_mn > 0 ? formatCommission(stats.pending_commissions_mn, 'MN') : ''}${stats.pending_commissions === 0 ? '$0.00' : ''}</div>
